async function GetDisposableProducts(){
    ...
    data.desechables.forEach(element => {
      products.innerHTML += generateDisposableProducts(element);
    });
